                    ...
                    <div class="x_content">
                        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                $total_records = Student::row_count();
                                $pagination = new Pagination($total_records);
                                $objects = Student::find_all_by_limit_offset($pagination->records_per_page, $pagination->offset());
                                ...
                                foreach ($objects as $role) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $role->age ?></td>
                                        <td><?php echo $role->student_status_id()->name ?></td>
                                        <td>
                                            <form action="student.php" method="post" style="float: left;">
