  ...
  <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
    <div class="menu_section">
      ...
      <ul class="nav side-menu">
        ...
        <li><a><i class="fa fa-user-secret"></i>Student <span class="fa fa-chevron-down"></span></a>
          <ul class="nav child_menu">
            <div class="menu_heading"><label >EDIT</label></div>
            <?php
            
            if(Functions::check_privilege_by_module_action("Role","ins")){
              echo '<li><a href="student.php">Add Student</a></li>';
            }
            ...
            if(Functions::check_privilege_by_module_action("Role","view")){
              echo '<li><a href="student_management.php">Student Management</a></li>';
            }
