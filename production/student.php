...
if (!(isset($_POST["id"]) && $student = Student::find_by_id($_POST["id"]))) {
    $student = new Student();
}
?>
    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2 id="title"><?php echo (empty($student->id)) ? 'Add' : 'Edit'; ?> Student</h2>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <form id="formRole" action="proccess/student_proccess.php" method="post" class="form-horizontal form-label-left" >
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <input type="hidden" class="form-control" id="txtId" name="id" value="<?php echo $student->id; ?>" />
                                <div class="form-group">

                                    <label>Name</label>
                                    <input type="text" class="form-control" placeholder="Name" id="txtName" name="name" value="<?php echo $student->name; ?>" required="">

                                    
                                    <label>Address</label>
                                    <input type="text" class="form-control" placeholder="Address" id="txtName" name="address" value="<?php echo $student->address; ?>" required="">
                                    <label>Age</label>
                                    <input type="text" class="form-control" placeholder="Age" id="txtName" name="age" value="<?php echo $student->age; ?>" required="">

                                    <label>Name</label>
                                    <select class="form-control" name="student_status_id">
                                    <?php 
                                        foreach (StudentStatus::find_all() as $status_data ) {
                                ...
                                <div class="modal-footer col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class=" col-md-4 col-sm-4 col-xs-12" style="display: <?php echo (empty($student->id)) ? 'none' : 'initial'; ?>">
...
//        });
    ...
    $("#btnSave").click(function () {
        var id = <?php echo ($student->id) ? 1 : 0; ?>;
